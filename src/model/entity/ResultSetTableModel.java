...
public class ResultSetTableModel extends AbstractTableModel{
    ...
    private final String url = "jdbc:mysql://localhost/sce";
    private final String nome = "tester";
    private final String senha = "tester123"; 
    
    //construtor inicilializa resultSEt e obtem seu objeto de metadados;
